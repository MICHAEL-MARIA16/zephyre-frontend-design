        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center space-x-3">
            <Button 
              ...
              className="border-white/30 text-white hover:bg-white/10"
              onClick={async () => {
                const shareText = `🌟 My Zephyre Skin Analysis Results 🌟\n\n🧬 Skin Type: ${userData.currentSkinType.toUpperCase()}\n📊 Confidence: ${userData.skinScore}%\n🌤️ Weather-Adapted Care\n\nDiscover your skin's needs with Zephyre - Your Weather-Powered Skincare Assistant!`;
                ...
                try {
                  if (navigator.share && navigator.canShare) {
                    ...
                    alert('Results copied to clipboard! Share it anywhere you like.');
                  }
                } catch (error) {
            ...
            <Button 
              ...
              onClick={() => {
                ...
                const skinCareRecommendations = {
                  cleanser: "Gentle foam cleanser for balanced skin",
                  moisturizer: "Lightweight, non-comedogenic moisturizer",
                  sunscreen: "SPF 30+ broad spectrum protection",
                  serums: "Vitamin C serum for morning, Niacinamide for evening",
                  specialTips: "Hydrate well, avoid over-washing, use lukewarm water"
                };
...
Cleanser: ${skinCareRecommendations.cleanser}
Moisturizer: ${skinCareRecommendations.moisturizer}
Sunscreen: ${skinCareRecommendations.sunscreen}
Serums: ${skinCareRecommendations.serums}
Special Tips: ${skinCareRecommendations.specialTips}

🌈 WEATHER-BASED TIPS
• Current humidity levels suggest using lighter moisturizer
• Temperature is moderate - perfect for vitamin C application
• Partly cloudy weather still requires SPF protection

📊 Generated by: Zephyre - Weather-Powered Skincare Assistant
📅 Export Date: ${new Date().toISOString()}
                ...
                downloadAnchor.setAttribute("download", `Zephyre-Skincare-Report-${userData.name.replace(/\s+/g, '-')}.txt`);
                document.body.appendChild(downloadAnchor);
                downloadAnchor.click();
                downloadAnchor.remove();
                
                alert('📄 Skincare report exported successfully! Check your downloads folder.');
              }}
            >
